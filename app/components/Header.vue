<template>
	...
	<!-- sticky top -->
	<header
		class="tw:sticky tw:top-0 tw:left-0 tw:px-3 tw:w-full tw:border-b tw:border-bc-stroke tw:md:border-dashed tw:border-solid tw:z-10"
	>
		<div
			class="max-container flex_between tw:gap-3 tw:border-x tw:border-bc-stroke tw:border-solid tw:md:py-8 tw:py-4 tw:sm:px-12 tw:px-4 tw:bg-bc-primary"
		>
			<!-- home link -->
			<NuxtLink
				to="/"
				class="tw:w-full tw:md:h-11 tw:h-8 tw:md:max-w-[20rem] tw:max-w-8 tw:bg-no-repeat tw:bg-contain tw:bg-(image:--logo) tw:md:bg-(image:--md-logo) tw:border-none tw:outline-none tw:focus:outline-none"
			/>
			<!-- right section -->
